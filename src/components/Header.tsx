  ...
  return (
     <header className="fixed top-0 left-0 right-0 z-50 glass-strong" dir="ltr">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
       ...
       <span dir="ltr" className="inline font-serif font-bold tracking-tight text-[13px] xs:text-[15px] md:text-xl text-amber-200/90 drop-shadow-[0_1px_4px_rgba(200,170,80,0.3)] whitespace-nowrap -ml-3">
