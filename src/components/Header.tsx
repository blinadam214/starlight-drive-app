...
<span className="inline font-serif font-bold tracking-tight text-[20px] md:text-xl text-amber-200/90 drop-shadow-[0_1px_4px_rgba(200,170,80,0.3)] whitespace-nowrap">
  LIGHT DRIVE26
</span>
          </a>
