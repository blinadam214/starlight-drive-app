      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <img src={logoKND} alt="Kech Night Drive — Location Premium Marrakech" className="h-24 w-24 md:h-28 md:w-28 object-contain mix-blend-screen -ml-2" />
           <span dir="ltr" className="inline font-serif font-bold tracking-tight text-[16px] md:text-xl text-amber-200/90 drop-shadow-[0_1px_4px_rgba(200,170,80,0.3)] whitespace-nowrap">
