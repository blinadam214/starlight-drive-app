      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <a href="/" className="flex items-center gap-0 group">
           <img src={logoKND} alt="Kech Night Drive — Location Premium Marrakech" className="h-18 w-18 md:h-20 md:w-20 object-contain mix-blend-screen" />
            <span className="inline font-serif font-bold tracking-tight text-[11px] md:text-xl text-amber-200/90 drop-shadow-[0_1<span className="inline font-serif font-bold tracking-tight text-[10px] md:text-base text-amber-200/90 drop-shadow-[0_1px_4px_rgba(200,170,80,0.3)] whitespace-nowrap -ml-2">px_4px_rgba(200,170,80,0.3)] whitespace-nowrap">
